...
@section('content')
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block img-fluid w-100" src="{{asset('storage/images/slide-1.jpg')}}" alt="">
                ...
                <div class="carousel-item">
                    <img class="d-block img-fluid w-100" src="{{asset('storage/images/slide-2.jpg')}}" alt="">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item">
                    <img class="d-block img-fluid w-100" src="{{asset('storage/images/slide-3.jpg')}}" alt="">
                    <div class="carousel-caption d-none d-md-block">
    ...
    <div class="bg-faded p-4 my-4">
        ...
        <hr class="divider">
        <img class="img-fluid float-left mr-4 d-none d-lg-block" src="{{asset('storage/images/intro-pic.jpg')}}" alt="">
